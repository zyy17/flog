...
func ExampleNewLog() {
	...
	created := time.Now()
	fmt.Println(NewLog("apache_common", 0, 0, 0, created))
	fmt.Println(NewLog("apache_combined", 0, 0, 0, created))
	fmt.Println(NewLog("apache_error", 0, 0, 0, created))
	fmt.Println(NewLog("rfc3164", 0, 0, 0, created))
	fmt.Println(NewLog("rfc5424", 0, 0, 0, created))
	fmt.Println(NewLog("common_log", 0, 0, 0, created))
	fmt.Println(NewLog("unknown", 0, 0, 0, created))
	fmt.Println(NewLog("json", 0, 0, 0, created))
	// Output:
